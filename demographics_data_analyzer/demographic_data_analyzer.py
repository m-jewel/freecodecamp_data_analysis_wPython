...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country_percentage = ((country_earnings / country_counts) * 100).round(1)
    ...
    if print_data:
        ...
        print(f"Highest percentage of rich people in country: {highest_earning_country_percentage[highest_earning_country]}%")
    ...
    return {
        ...
        'highest_earning_country_percentage': highest_earning_country_percentage[highest_earning_country],
